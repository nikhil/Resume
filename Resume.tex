...
\hfill
\dateright{Expected May 2017}
\descripta{Bachelor of Science in Biomedical Engineering, Minor: Computer Science}
\hfill
\dateright{May 2016}

\location{Cumulative GPA: 3.77 / 4.0} 
\begin{tightitemize}
	\item Engineering Honors Program, Dean's List (All Semesters), 5 year Biomedical Engineering B.S./M.S. Program 
...
\descripta{Relevant Graduate Coursework:}
...
%\hrule \leavevmode \\
\vspace{2 mm}
\runsubsectiona{Harvard-MIT Health Sciences and Technology}
\hfill
...
%------------------------------------------------
\runsubsectiona{Finite Element Analysis of the Lower Extremity}
\hfill
\dateright{Piscataway, NJ}
\descripta{James J. Slade Scholar Research}
\hfill
\dateright{September 2014 - May 2016}
\vspace{1 mm}
\begin{tightitemize}
