...
%------------------------------------------------
\runsubsectiona{Lower Extremity Biomechanics Analysis}
\hfill
\dateright{Piscataway, NJ}
...
%	\item Independent research with Department Chair Dr. Noshir Langrana.
	\item Modeled the difference between shod running and barefoot running using SolidWorks. 
	\item Performed various Finite Element Analysis experiments in SolidWorks.   
 \end{tightitemize}
